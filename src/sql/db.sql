...
create table public.products (
  ...
  subtitle text,
  price integer not null,                  -- store rupees as integer
  original_price integer,                  -- nullable
  image text not null,
  category text not null,                  -- matches your current `Category.name`
  rating numeric(2,1) default 0,
  reviews integer default 0,
  in_stock boolean default true,
  featured boolean default false,
  is_new boolean default false,           -- maps to TS field `new`
  created_at timestamptz default now(),
...
-- CARTS
-- =========
-- For guests you can still use localStorage; this table is for logged-in persistence.
...
create table if not exists public.products (
  ...
  image text not null,
  category text not null,       -- "Vases", "Planters", etc.
  rating numeric(2,1) default 0,
  reviews integer default 0,
  in_stock boolean default true,
  featured boolean default false,
